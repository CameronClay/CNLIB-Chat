...
#define MSG_WHITEBOARD_DRAWLINE -119
#define MSG_WHITEBOARD_REQUEST_IMAGE -118
#define MSG_WHITEBOARD_FORWARD_IMAGE -117
#define MSG_WHITEBOARD_CLEAR -116
