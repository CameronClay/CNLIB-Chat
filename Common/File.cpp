...
#else
	char buff[128];
	MultiByteToWideChar(CP_ACP, 0, buff, 128, (TCHAR*)title, 128);
	pd->SetTitle(titleBuff);
	MultiByteToWideChar(CP_ACP, 0, buff, 128, (TCHAR*)line0, 128);
	pd->SetLine(0, line0Buff, false, NULL);
	MultiByteToWideChar(CP_ACP, 0, buff, 128, (TCHAR*)cancelMsg, 128);
	pd->SetCancelMsg(cancelMsgBuff, NULL);
#endif
...
#else
	char line1Buff[255];
	MultiByteToWideChar(CP_ACP, 0, line1Buff, 128, (TCHAR*)line1, 255);
	pd->SetLine(1, line1Buff, true, NULL);
#endif
}
